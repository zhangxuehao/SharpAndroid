 ...
 */
package com.sharpandroid.framework.widget.scancode;
...
import com.sharpandroid.framework.widget.scancode.defineview.MyImageView;
import com.sharpandroid.framework.widget.scancode.utils.Constant;
import com.sharpandroid.framework.widget.scancode.zxing.ScanListener;
import com.sharpandroid.framework.widget.scancode.zxing.ScanManager;
import com.sharpandroid.framework.widget.scancode.zxing.decode.DecodeThread;
import com.sharpandroid.framework.widget.scancode.zxing.decode.Utils;
...
public final class CommonScanActivity extends Activity implements ScanListener, View.OnClickListener {
    ...
    private TextView qrcodeGGallery;
    ...
    private void assignViews() {
        ...
        qrcodeGGallery = (TextView) findViewById(R.id.qrcode_g_gallery);
